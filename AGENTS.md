...
- `bun.lock:Zone.Identifier/` — explain what lives here and when agents should edit it.
- `Caddyfile/` — explain what lives here and when agents should edit it.
- `Caddyfile:Zone.Identifier/` — explain what lives here and when agents should edit it.
- `components.json/` — explain what lives here and when agents should edit it.
- `components.json:Zone.Identifier/` — explain what lives here and when agents should edit it.
